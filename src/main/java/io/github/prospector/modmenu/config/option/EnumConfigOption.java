...
public class EnumConfigOption<E extends Enum<E>> implements ConfigOption {
	...
	private static <E extends Enum<E>> String getValueText(EnumConfigOption<E> option, E value) {
		return TranslationStorage.getInstance().get(option.translationKey + "." + value.name().toLowerCase(Locale.ROOT));
	}

	@Override
	public String getValueLabel() {
		return TranslationUtil.translateOptionLabel(TranslationStorage.getInstance().get(translationKey), getValueText(this, getValue()));
	}
