package net.danygames2014.modmenu.util.mod.fabric;

import com.google.common.collect.Lists;
import com.google.common.collect.Sets;
import net.danygames2014.modmenu.ModMenu;
import net.danygames2014.modmenu.config.ModMenuConfig;
import net.danygames2014.modmenu.util.OptionalUtil;
import net.danygames2014.modmenu.util.VersionUtil;
...
//			}
	...
	public @NotNull String getTranslatedDescription() {
		...
		if (getId().equals("java")) {
			description = description + "\n" + TranslationStorage.getInstance().get("modmenu.javaDistributionName", getName());
		}
		return description;
	}
