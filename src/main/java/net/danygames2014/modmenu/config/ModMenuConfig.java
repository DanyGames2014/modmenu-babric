package net.danygames2014.modmenu.config;

import com.google.gson.annotations.SerializedName;
import net.danygames2014.modmenu.config.option.BooleanConfigOption;
import net.danygames2014.modmenu.config.option.ConfigOption;
import net.danygames2014.modmenu.config.option.EnumConfigOption;
import net.danygames2014.modmenu.config.option.StringSetConfigOption;
...
public class ModMenuConfig {
	...
	public static final EnumConfigOption<TitleMenuButtonStyle> MODS_BUTTON_STYLE = new EnumConfigOption<>("mods_button_style", TitleMenuButtonStyle.SHRINK);
	public static final EnumConfigOption<GameMenuButtonStyle> GAME_MENU_BUTTON_STYLE = new EnumConfigOption<>("game_menu_button_style", GameMenuButtonStyle.BELOW_STATISTICS);
	public static final BooleanConfigOption COUNT_HIDDEN_MODS = new BooleanConfigOption("count_hidden_mods", true);
	public static final EnumConfigOption<ModCountLocation> MOD_COUNT_LOCATION = new EnumConfigOption<>("mod_count_location", ModCountLocation.TITLE_SCREEN_AND_MODS_BUTTON);
